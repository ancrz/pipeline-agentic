...
2. **SKILL PROVISIONING**
   ...
   d. Verify the canonical installation in `~/.agents/skills/` and the
      client-specific discovery link (`~/.gemini/skills/` for Gemini CLI or
      `~/.gemini/config/skills/` for Antigravity / agy).
